...
const numbers = [45, 55, 65, 75, 85]; // Note: Changed the array to contain numbers, not strings
...
const firstIndexOf7 = ranks.findIndex((rank) => rank === 7);
console.log(firstIndexOf7);
